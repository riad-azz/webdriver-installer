...
class Opera(DriverInstaller):
    def __init__(self):
        super().__init__(name='operadriver',
                         filename='operadriver',
                         base_url='https://github.com',
                         version_url='https://github.com/operasoftware/operachromiumdriver/releases/latest')

    def get_download_url(self, version: str, bit: str) -> str:
        TARGET = f'win{bit}.zip'
        URL = f'https://github.com/operasoftware/operachromiumdriver/releases/expanded_assets/{version}'
